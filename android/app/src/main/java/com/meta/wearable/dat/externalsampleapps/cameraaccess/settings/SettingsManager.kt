...
object SettingsManager {
    private const val PREFS_NAME = "hive_settings"
    ...
    var hiveServerUrl: String
        get() = prefs.getString("hiveServerUrl", null) ?: Secrets.hiveServerUrl
        set(value) = prefs.edit().putString("hiveServerUrl", value).apply()

    var hiveAuthToken: String
        get() = prefs.getString("hiveAuthToken", null) ?: Secrets.hiveAuthToken
        set(value) = prefs.edit().putString("hiveAuthToken", value).apply()

    var hiveDeviceToken: String?
